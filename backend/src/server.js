...
import adminSiteConfigRoute from "./routes/admin/siteConfig.route.js";
import siteConfigPublicRoute from "./routes/siteConfigPublic.route.js";
import adminMarqueeRoute from "./routes/admin/marquee.route.js";
import adminPromotionRoute from "./routes/admin/promotion.route.js";
import promotionPublicRoute from "./routes/promotionPublic.route.js";
import marqueeRoute from "./routes/marquee.route.js";
...
app.use("/api/admin/site-config", adminSiteConfigRoute);
app.use("/api/admin/promotions", adminPromotionRoute);
app.use("/api/admin/marquee", adminMarqueeRoute);
app.use("/api/admin/ui", adminUiRouter);
app.use("/api/ui", publicUiRouter);
app.use("/api/ui", siteConfigPublicRoute);
app.use("/api/ui/promotions", promotionPublicRoute);
app.use("/api/ui/marquee", marqueeRoute);
